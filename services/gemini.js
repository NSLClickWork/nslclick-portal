...
const { OpenAI } = require('openai');
    ...
    async function chatWithGemini(prompt, userRole = 'partner', userLang = 'de', partnerConfig = null, filteredIds = null) {
        ...
        try {
            ...
            return "Xin lỗi, hệ thống AI hiện đang quá tải hoàn toàn. Vui lòng thử lại sau ít phút hoặc liên hệ admin@nslclickwork.com.";
    }
}
